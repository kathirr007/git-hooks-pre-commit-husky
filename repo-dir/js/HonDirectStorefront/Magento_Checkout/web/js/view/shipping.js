...
define([
  ...
  return Component.extend({
    ...
    initialize: function () {
      ...
      $('.breadcrumbs .items .Review').hide()
      $('.breadcrumbs .items .Payment').hide()
      $('.breadcrumbs .items .Payment').css('display', 'none')
      $('.breadcrumbs .items .Review').css('display', 'none')
          ...
          if (count > 0) {
            ...
            if (
              ...
              $('.action-save-address')
                .parent()
                .append(
                  `<span id="shipping-address-validation-error-message-id" generated="true" style= "color:red;" class="shipping-address-validation-error-message mage-error">${
                                        $t(
